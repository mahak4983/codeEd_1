...
const Element2 = () => {
    return (
        <div className="container-fluid center" >
            <br />
            <br />
            <h1 className={styles.h1}>Code And Learn</h1><br />
            <h1 className={styles.h1}>from around the world</h1>
            <br />
            <br />
            <div className="row" style={{ padding: '4%' }}>
                <div className="col s12 m4 l4">
                    ...
                    <p className={styles.p}>Learn in demand technologies and skills</p>
                </div>
                <div className="col s12 m4 l4">
                    ...
                    <p className={styles.p}>Validate Your skills and see them on your dev-profile</p>
                </div>
                <div className="col s12 m4 l4">
                    ...
                    <p className={styles.p}>Win prizes for competitons organized!</p>
                </div>
            </div>
